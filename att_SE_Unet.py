...
class attSEunet(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, first_filter_num=64):
        ...
        self.se4 = SELayer(8 * first_filter_num)
        ...
        self.se3 = SELayer(4 * first_filter_num)
        ...
        self.se2 = SELayer(2 * first_filter_num)
        ...
        self.se1 = SELayer(1 * first_filter_num)
